				...
				$(document)
						.ready(
								function() {
									...
									$('.totalSearch_wrap input[type=text]')
											.on(
													{
														focusin : function() {
															$(
			...
			<div id="contents" class="">
				...
				<div class="wrap-login">
						...
						<div class="box-login">
							...
							<div>
								<a href="javascript:getNaverLoginURL();" class="btn_loginNaver"><img
									src="https://img.cgv.co.kr/image_gt/login/btn_loginNaver.jpg"
									alt="네이버 로그인"></a>
							</div>
						</div>
					</div>
					...
					<div class="sect-loginad" style="background: #d2cbbe;">
						<div>
							<iframe
								src="https://ad.cgv.co.kr/NetInsight/html/CGV/CGV_201401/sub@Login_bigbanner"
						...
						$(function() {
									...
									.change(
											function() {
												if ($("#loginSet").is(
													...
													setCookie(
															"cgv.cookie.UserID_RE=UserID_RE",
															$("#txtUserId")
																	.val(), 7);
												} else {
													setCookie(
							...
							function getCookie(cookieName) {
								...
								if (start != -1) {
									...
									cookieValue = cookieData.substring(start,
											end);
								}
